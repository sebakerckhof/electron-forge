...
export default async (providedOptions = {}) => {
  ...
  if (electronName) {
    ...
    packageJSON.devDependencies['@sebak/electron-prebuilt-compile'] = electronVersion;
  }
  ...
  await asyncOra('Installing dependencies', async () => {
    ...
    await installDepList(dir, exactDevDeps.map((dep) => {
      if (dep === '@sebak/electron-prebuilt-compile') {
...
Nothing much will have changed but we added the ${'"@sebak/electron-prebuilt-compile"'.cyan} dependency.  This is \
